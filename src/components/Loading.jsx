...
export const Loading = () => {
  return (
    <div class="flex flex-col items-center justify-center text-sm max-md:px-4">
      ...
      <p class="text-2xl md:text-3xl font-bold text-gray-800">Loading.....</p>
      ...
      <div class="flex items-center gap-4 mt-6">
        <a
          href="/"
          class="bg-gray-800 hover:bg-black px-7 py-2.5 text-white rounded-md active:scale-95 transition-all"
        >
          Return Home
        </a>
        <a
          href="#"
          class="border border-gray-300 px-7 py-2.5 text-gray-800 rounded-md active:scale-95 transition-all"
        >
          Contact support
        </a>
      </div>
